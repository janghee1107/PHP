<?
	...
	$query="insert into product (  menu47, code47, name47, coname47, price47, opt147, opt247,  contents47,
	 status47, icon_new47, icon_hit47, icon_sale47, discount47, regday47, image147 )
				values ( '$menu', '$code', '$name', '$coname', '$price', '$opt1', $opt2',  '$contents',
	 '$status', '$icon_new', '$icon_hit', '$icon_sale', '$discount', '$regday1', '$fname1', '$fname2', '$fname3'   );";
